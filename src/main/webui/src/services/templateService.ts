...
export async function fetchTemplates(
  ...
  const result = await graphqlFetch<{ templates: CalendarTemplate[] }>(query, {
    isActive,
  });
...
export async function fetchTemplate(
  ...
  const result = await graphqlFetch<{ template: CalendarTemplate }>(query, {
    id,
  });
...
export async function createTemplate(
  ...
  const result = await graphqlFetch<{ createTemplate: CalendarTemplate }>(
    query,
    { input },
  );
...
export async function updateTemplate(
  ...
  const result = await graphqlFetch<{ updateTemplate: CalendarTemplate }>(
    query,
    { id, input },
  );
