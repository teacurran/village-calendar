<template>
  <div class="calendar-generator">
    ...
    >
      ...
      <div class="config-content overflow-y-auto" style="height: calc(100vh - 180px)">
        <!-- Calendar Type Selection (Outside Accordion) -->
        <div class="p-4 mb-4 border-b">
          <label for="calendarType" class="block text-sm font-medium mb-2">Calendar Type</label>
          <Dropdown
            ...
            class="w-full"
          />
          <div v-if="config.calendarType === 'hebrew'" class="mt-2 text-xs text-gray-600">
        ...
        <Accordion :multiple="true" :active-index="[0, 1, 2, 3, 4]">
            ...
            <div class="space-y-4 p-3">
              ...
              <div>
                ...
                <InputNumber
                  ...
                  :useGrouping="false"
                />
                <div v-if="config.calendarType === 'hebrew'" class="text-xs text-gray-600 mt-1">
              ...
              <div>
                <label for="layoutStyle" class="block text-sm font-medium mb-1">Layout Style</label>
                <Dropdown
              ...
              <div>
                <label for="firstDay" class="block text-sm font-medium mb-1">
                  First Day of Week
                  <span
                    v-if="config.layoutStyle === 'grid' || config.layoutStyle === 'weekday-grid'"
                ...
                <Dropdown
                  ...
                  option-label="label"
                  option-value="value"
                  :disabled="config.layoutStyle === 'grid' || config.layoutStyle === 'weekday-grid'"
                  class="w-full"
                />
              </div>
            </div>
          ...
          <AccordionTab header="Display Options">
            <div class="space-y-3 p-3">
              <div class="flex items-center">
                <Checkbox v-model="config.showWeekNumbers" input-id="weekNumbers" binary />
                <label for="weekNumbers" class="ml-2">Show Week Numbers</label>
              </div>
              <div class="flex items-center">
                <Checkbox v-model="config.compactMode" input-id="compactMode" binary />
                <label for="compactMode" class="ml-2">Compact Mode</label>
              </div>
              <div class="mt-4">
                <label for="emojiPosition" class="block text-sm font-medium mb-1"
          ...
          >
            <div class="space-y-3 p-3">
              <div class="flex items-center">
                <Checkbox v-model="config.showDayNumbers" input-id="dayNumbers" binary />
                <label for="dayNumbers" class="ml-2">Show Day Numbers (1-31)</label>
              </div>
              <div class="flex items-center">
                <Checkbox v-model="config.showDayNames" input-id="dayNames" binary />
                <label for="dayNames" class="ml-2">Show Day Names (Sun, Mon, ...)</label>
              </div>
              <div class="flex items-center">
              ...
              <div class="flex items-center">
                <Checkbox v-model="config.highlightWeekends" input-id="highlightWeekends" binary />
                <label for="highlightWeekends" class="ml-2">Highlight Weekends</label>
              </div>
              <div class="flex items-center">
                <Checkbox v-model="config.rotateMonthNames" input-id="rotateMonthNames" binary />
                <label for="rotateMonthNames" class="ml-2">Rotate Month Names</label>
              </div>
            </div>
          </AccordionTab>
          ...
          <AccordionTab header="Moon & Location">
            <div class="space-y-4 p-3">
              <div class="bg-gray-50 p-3 rounded-lg">
                ...
                <div class="space-y-3">
                  <div class="field">
                    <label for="moonDisplayMode" class="text-sm font-medium">Moon Display Mode</label>
                    <Dropdown
                      v-model="config.moonDisplayMode"
                      :options="[
                        { label: 'None', value: 'none' },
                        { label: 'Moon Phases (Small Icons)', value: 'phases' },
                        { label: 'Moon Illumination (Detailed)', value: 'illumination' }
                      ]"
                      option-label="label"
                      option-value="value"
              ...
              <div v-if="config.moonDisplayMode !== 'none'" class="space-y-3">
                <div class="bg-blue-50 p-3 rounded-lg">
                  ...
                  <div class="space-y-3">
                    <div>
                      <label for="city-select" class="block text-sm font-medium mb-1"
                      ...
                      <Dropdown
                        ...
                        @change="onCitySelect"
                      />
                      <div v-if="config.latitude === 0 && config.longitude === 0" class="text-xs text-gray-600 mt-1">
                        Moon will display without rotation when no location is selected
                      </div>
                    </div>
                    <div class="grid grid-cols-2 gap-3">
                      <div>
                        <label for="latitude" class="block text-sm font-medium mb-1"
                          >Latitude</label
                        >
                        <InputNumber
                          id="latitude"
                      ...
                      <div>
                        <label for="longitude" class="block text-sm font-medium mb-1"
                          >Longitude</label
                        >
                        <InputNumber
                          id="longitude"
                ...
                <div class="bg-purple-50 p-3 rounded-lg">
                  ...
                  <div class="space-y-3">
                    <div class="grid grid-cols-2 gap-3">
                      <div>
                        <label for="moonSize" class="block text-sm font-medium mb-1"
                          >Moon Size</label
                        >
                        <InputNumber
                          id="moonSize"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                      <div>
                        <label for="moonOffsetX" class="block text-sm font-medium mb-1"
                          >X Position</label
                        >
                        <InputNumber
                          id="moonOffsetX"
                      ...
                      <div>
                        <label for="moonOffsetY" class="block text-sm font-medium mb-1"
                          >Y Position</label
                        >
                        <InputNumber
                          id="moonOffsetY"
                    ...
                    <div>
                      <label for="moonBorderColor" class="block text-sm font-medium mb-1"
                        >Border Color</label
                      >
                    ...
                    <div>
                      <label for="moonBorderWidth" class="block text-sm font-medium mb-1"
                        >Border Width</label
                      >
                      <InputNumber
                        id="moonBorderWidth"
                    ...
                    <div>
                      <label for="moonDarkColor" class="block text-sm font-medium mb-1"
                    ...
                    <div>
                      <label for="moonLightColor" class="block text-sm font-medium mb-1"
          ...
          <AccordionTab header="Color Customization">
            <div class="p-3 space-y-3">
              <div class="grid grid-cols-1 gap-3">
                <div>
                  <label for="yearColor" class="block text-sm font-medium mb-1">Year Text</label>
                  <div class="flex gap-2">
                    <InputText
                      id="yearColor"
                ...
                <div>
                  <label for="monthColor" class="block text-sm font-medium mb-1">Month Names</label>
                  <div class="flex gap-2">
                    <InputText
                      id="monthColor"
                ...
                <div>
                  <label for="dayTextColor" class="block text-sm font-medium mb-1"
                    >Day Numbers</label
                  >
                  <div class="flex gap-2">
                    <InputText
                ...
                <div>
                  <label for="dayNameColor" class="block text-sm font-medium mb-1">Day Names</label>
                  <div class="flex gap-2">
                    <InputText
                      id="dayNameColor"
                ...
                <div>
                  <label for="gridLineColor" class="block text-sm font-medium mb-1"
                    >Grid Lines</label
                  >
                  <div class="flex gap-2">
                    <InputText
                ...
                <div>
                  <label for="weekendBgColor" class="block text-sm font-medium mb-1"
                ...
                <div>
                  <label for="holidayColor" class="block text-sm font-medium mb-1"
                    >Holiday Text</label
                  >
                  <div class="flex gap-2">
                    <InputText
                ...
                <div>
                  <label for="customDateColor" class="block text-sm font-medium mb-1"
            ...
            <div class="p-3">
              ...
              <div class="flex flex-col gap-3">
                <div class="text-sm text-gray-700">
                  <span v-if="customEvents.length === 0">No events added yet</span>
                  <span v-else
      ...
      <template #footer>
        <div class="flex gap-2">
          ...
          />
          <Button label="Close" icon="pi pi-times" outlined @click="drawerVisible = false" />
        </div>
      </template>
    </Drawer>
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-2">
          ...
          <Button
            ...
            icon="pi pi-calendar-plus"
            outlined
            :badge="customEvents.length > 0 ? customEvents.length.toString() : null"
            badge-severity="info"
            @click="showEventsDialog = true"
          />
          <Button label="Settings" icon="pi pi-cog" outlined @click="drawerVisible = true" />
        </div>
      </div>
  ...
  >
    ...
    <div v-else class="space-y-4">
      <DataTable :value="templates" :paginator="true" :rows="10" responsive-layout="scroll">
        ...
        <Column header="Status" style="width: 120px">
          <template #body="slotProps">
            <div class="flex gap-2">
              <Tag v-if="slotProps.data.isActive" value="Active" severity="success" />
              <Tag v-if="slotProps.data.isFeatured" value="Featured" severity="warning" />
            </div>
          </template>
        </Column>
  ...
  >
    <div class="space-y-4">
      <div>
        ...
        <InputText
          ...
          :class="{ 'p-invalid': !templateToSave.name && showSaveTemplateDialog }"
        />
        <small v-if="!templateToSave.name && showSaveTemplateDialog" class="p-error"
      ...
      <div class="flex gap-4">
        <div class="flex items-center">
          <Checkbox v-model="templateToSave.isActive" input-id="template-active" binary />
          <label for="template-active" class="ml-2">Active</label>
        </div>

        <div class="flex items-center">
          <Checkbox v-model="templateToSave.isFeatured" input-id="template-featured" binary />
    ...
    <template #footer>
      ...
      <Button label="Save Template" :disabled="!templateToSave.name" @click="confirmSaveTemplate" />
    </template>
  </Dialog>
  ...
  >
    <div class="space-y-4">
      <div>
        ...
        />
        <small v-if="!duplicateName && showDuplicateDialog" class="p-error">Name is required</small>
      </div>
    </div>

    <template #footer>
      <Button label="Cancel" text @click="showDuplicateDialog = false" />
      <Button label="Duplicate" :disabled="!duplicateName" @click="confirmDuplicateTemplate" />
    </template>
  </Dialog>
    ...
    <div class="space-y-4">
      ...
      >
        <div
          ...
          :class="{ 'ring-2 ring-blue-500': selectedSavedCalendar?.id === calendar.id }"
        >
          <!-- Calendar Preview -->
          <div class="mb-3">
            <div class="bg-gray-100 rounded p-2 h-48 overflow-hidden relative">
              ...
              <div
                v-else-if="
                  calendarPreviews[calendar.id] && calendarPreviews[calendar.id] !== 'error'
                "
                class="w-full h-full"
              ...
              <div v-else class="h-full flex items-center justify-center">
                <div class="text-center">
                  ...
                  >
                    {{ Object.keys(calendar.configuration.customDates).length }} custom event(s)
                  </p>
                </div>
              </div>
            </div>
          ...
          <!-- Action Buttons -->
          <div class="flex gap-2">
            <Button label="Load" size="small" class="flex-1" @click="loadSavedCalendar(calendar)" />
            <Button
              label="Edit"
              size="small"
              outlined
      ...
      <div v-else class="text-center py-8">
        ...
        <p class="text-sm text-gray-400 mt-2">Generate a calendar and save it to see it here</p>
      </div>
    </div>
  ...
  >
    ...
    <div v-if="!showEventForm" class="space-y-4">
      ...
      <div class="border rounded-lg">
        ...
        >
          ...
          <Column field="emoji" header="Emoji" style="width: 80px; text-align: center">
            <template #body="slotProps">
          ...
          <Column field="showTitle" header="Show Title" style="width: 120px">
            <template #body="slotProps">
              <Tag :severity="slotProps.data.showTitle ? 'success' : 'secondary'">
    ...
    <div v-else class="space-y-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <!-- Event Form -->
        <div class="border rounded-lg p-4 bg-gray-50">
          <h3 class="font-semibold mb-3">{{ isEditingEvent ? 'Edit Event' : 'Add Event' }}</h3>
          <div class="space-y-3">
            <div>
            ...
            <div class="flex items-center gap-4">
              <Checkbox v-model="newEvent.showTitle" input-id="show-title" binary />
              <label for="show-title" class="text-sm">Display title on calendar</label>
            </div>
            <div class="flex justify-end gap-2 pt-2">
              <Button label="Clear" icon="pi pi-times" text size="small" @click="clearNewEvent" />
              <Button
                v-if="isEditingEvent"
                label="Cancel Edit"
                text
  ...
  <!-- Emoji Picker Dialog -->
  <Dialog v-model:visible="showEmojiPicker" modal header="Select Emoji" :style="{ width: '400px' }">
...
const defaultYear = currentMonth <= 2 ? currentDate.getFullYear() : currentDate.getFullYear() + 1
...
const popularCities = ref([
  ...
  { label: 'Groton, VT, USA (HQ)', value: 'groton_vt', lat: 44.2172, lng: -72.2011 }, // Keep HQ at top

  // All other cities alphabetically
  { label: 'Abu Dhabi, UAE', value: 'abu_dhabi', lat: 24.4539, lng: 54.3773 },
  { label: 'Adelaide, Australia', value: 'adelaide', lat: -34.9285, lng: 138.6007 },
  { label: 'Ahmedabad, India', value: 'ahmedabad', lat: 23.0225, lng: 72.5714 },
  { label: 'Alexandria, Egypt', value: 'alexandria', lat: 31.2001, lng: 29.9187 },
  { label: 'Amsterdam, Netherlands', value: 'amsterdam', lat: 52.3676, lng: 4.9041 },
  { label: 'Athens, Greece', value: 'athens', lat: 37.9838, lng: 23.7275 },
  { label: 'Atlanta, GA, USA', value: 'atlanta', lat: 33.749, lng: -84.388 },
  { label: 'Auckland, New Zealand', value: 'auckland', lat: -36.8485, lng: 174.7633 },
  ...
  { label: 'Brisbane, Australia', value: 'brisbane', lat: -27.4698, lng: 153.0251 },
  ...
  { label: 'Buenos Aires, Argentina', value: 'buenos_aires', lat: -34.6037, lng: -58.3816 },
  { label: 'Burlington, VT, USA', value: 'burlington_vt', lat: 44.4759, lng: -73.2121 },
  ...
  { label: 'Cape Town, South Africa', value: 'cape_town', lat: -33.9249, lng: 18.4241 },
  { label: 'Caracas, Venezuela', value: 'caracas', lat: 10.4806, lng: -66.9036 },
  { label: 'Casablanca, Morocco', value: 'casablanca', lat: 33.5731, lng: -7.5898 },
  { label: 'Charlotte, NC, USA', value: 'charlotte', lat: 35.2271, lng: -80.8431 },
  ...
  { label: 'Christchurch, New Zealand', value: 'christchurch', lat: -43.5321, lng: 172.6362 },
  { label: 'Cincinnati, OH, USA', value: 'cincinnati', lat: 39.1031, lng: -84.512 },
  { label: 'Cleveland, OH, USA', value: 'cleveland', lat: 41.4993, lng: -81.6944 },
  { label: 'Copenhagen, Denmark', value: 'copenhagen', lat: 55.6761, lng: 12.5683 },
  ...
  { label: 'Durban, South Africa', value: 'durban', lat: -29.8587, lng: 31.0218 },
  { label: 'Edinburgh, UK', value: 'edinburgh', lat: 55.9533, lng: -3.1883 },
  { label: 'Edmonton, Canada', value: 'edmonton', lat: 53.5461, lng: -113.4938 },
  { label: 'Frankfurt, Germany', value: 'frankfurt', lat: 50.1109, lng: 8.6821 },
  { label: 'Geneva, Switzerland', value: 'geneva', lat: 46.2044, lng: 6.1432 },
  { label: 'Guadalajara, Mexico', value: 'guadalajara', lat: 20.6597, lng: -103.3496 },
  { label: 'Guangzhou, China', value: 'guangzhou', lat: 23.1291, lng: 113.2644 },
  ...
  { label: 'Ho Chi Minh City, Vietnam', value: 'ho_chi_minh', lat: 10.8231, lng: 106.6297 },
  ...
  { label: 'Jakarta, Indonesia', value: 'jakarta', lat: -6.2088, lng: 106.8456 },
  { label: 'Jerusalem, Israel', value: 'jerusalem', lat: 31.7683, lng: 35.2137 },
  { label: 'Johannesburg, South Africa', value: 'johannesburg', lat: -26.2041, lng: 28.0473 },
  { label: 'Kansas City, MO, USA', value: 'kansas_city', lat: 39.0997, lng: -94.5786 },
  { label: 'Kolkata, India', value: 'kolkata', lat: 22.5726, lng: 88.3639 },
  { label: 'Kuala Lumpur, Malaysia', value: 'kuala_lumpur', lat: 3.139, lng: 101.6869 },
  { label: 'Kuwait City, Kuwait', value: 'kuwait_city', lat: 29.3759, lng: 47.9774 },
  { label: 'Kyoto, Japan', value: 'kyoto', lat: 35.0116, lng: 135.7681 },
  { label: 'Lagos, Nigeria', value: 'lagos', lat: 6.5244, lng: 3.3792 },
  { label: 'Las Vegas, NV, USA', value: 'las_vegas', lat: 36.1699, lng: -115.1398 },
  ...
  { label: 'Los Angeles, CA, USA', value: 'los_angeles', lat: 34.0522, lng: -118.2437 },
  ...
  { label: 'Manila, Philippines', value: 'manila', lat: 14.5995, lng: 120.9842 },
  { label: 'Marseille, France', value: 'marseille', lat: 43.2965, lng: 5.3698 },
  { label: 'Melbourne, Australia', value: 'melbourne', lat: -37.8136, lng: 144.9631 },
  { label: 'Mexico City, Mexico', value: 'mexico_city', lat: 19.4326, lng: -99.1332 },
  { label: 'Miami, FL, USA', value: 'miami', lat: 25.7617, lng: -80.1918 },
  { label: 'Milan, Italy', value: 'milan', lat: 45.4642, lng: 9.19 },
  { label: 'Milwaukee, WI, USA', value: 'milwaukee', lat: 43.0389, lng: -87.9065 },
  { label: 'Minneapolis, MN, USA', value: 'minneapolis', lat: 44.9778, lng: -93.265 },
  { label: 'Monterrey, Mexico', value: 'monterrey', lat: 25.6866, lng: -100.3161 },
  ...
  { label: 'Nashville, TN, USA', value: 'nashville', lat: 36.1627, lng: -86.7816 },
  ...
  { label: 'Philadelphia, PA, USA', value: 'philadelphia', lat: 39.9526, lng: -75.1652 },
  { label: 'Phoenix, AZ, USA', value: 'phoenix', lat: 33.4484, lng: -112.074 },
  { label: 'Pittsburgh, PA, USA', value: 'pittsburgh', lat: 40.4406, lng: -79.9959 },
  { label: 'Portland, ME, USA', value: 'portland_me', lat: 43.6591, lng: -70.2568 },
  { label: 'Portland, OR, USA', value: 'portland_or', lat: 45.5152, lng: -122.6784 },
  { label: 'Porto, Portugal', value: 'porto', lat: 41.1579, lng: -8.6291 },
  { label: 'Prague, Czech Republic', value: 'prague', lat: 50.0755, lng: 14.4378 },
  { label: 'Providence, RI, USA', value: 'providence', lat: 41.824, lng: -71.4128 },
  { label: 'Pune, India', value: 'pune', lat: 18.5204, lng: 73.8567 },
  { label: 'Quebec City, Canada', value: 'quebec_city', lat: 46.8139, lng: -71.208 },
  { label: 'Reykjavik, Iceland', value: 'reykjavik', lat: 64.1466, lng: -21.9426 },
  { label: 'Rio de Janeiro, Brazil', value: 'rio', lat: -22.9068, lng: -43.1729 },
  { label: 'Riyadh, Saudi Arabia', value: 'riyadh', lat: 24.7136, lng: 46.6753 },
  { label: 'Rome, Italy', value: 'rome', lat: 41.9028, lng: 12.4964 },
  { label: 'Salt Lake City, UT, USA', value: 'salt_lake_city', lat: 40.7608, lng: -111.891 },
  { label: 'San Antonio, TX, USA', value: 'san_antonio', lat: 29.4241, lng: -98.4936 },
  { label: 'San Diego, CA, USA', value: 'san_diego', lat: 32.7157, lng: -117.1611 },
  { label: 'San Francisco, CA, USA', value: 'san_francisco', lat: 37.7749, lng: -122.4194 },
  { label: 'Santiago, Chile', value: 'santiago', lat: -33.4489, lng: -70.6693 },
  { label: 'São Paulo, Brazil', value: 'sao_paulo', lat: -23.5505, lng: -46.6333 },
  ...
  { label: 'South Haven, MI, USA', value: 'south_haven', lat: 42.4031, lng: -86.2736 },
  { label: 'St. Louis, MO, USA', value: 'st_louis', lat: 38.627, lng: -90.1994 },
  { label: 'St. Petersburg, Russia', value: 'st_petersburg', lat: 59.9311, lng: 30.3609 },
  { label: 'Stockholm, Sweden', value: 'stockholm', lat: 59.3293, lng: 18.0686 },
  ...
  { label: 'Vancouver, Canada', value: 'vancouver', lat: 49.2827, lng: -123.1207 },
  { label: 'Vienna, Austria', value: 'vienna', lat: 48.2082, lng: 16.3738 },
  { label: 'Warsaw, Poland', value: 'warsaw', lat: 52.2297, lng: 21.0122 },
  { label: 'Wellington, New Zealand', value: 'wellington', lat: -41.2865, lng: 174.7762 },
...
watch(
  ...
  (newYear) => {
    ...
    if (!newEvent.value.date || new Date(newEvent.value.date).getFullYear() !== newYear) {
...
const fetchHolidays = async () => {
  try {
    const response = await fetch(`/api/calendar/holidays?year=${config.value.year}&country=US`)
    if (response.ok) {
...
const generateCalendar = async () => {
  try {
    ...
    const request = {
      ...
      showHolidays: selectedHolidaySet.value && selectedHolidaySet.value !== 'none',
      locale: 'en-US',
    }
...
const addHolidaySet = () => {
  ...
  holidays.forEach((holiday) => {
    ...
    if (holiday.hebrewDate) {
      ...
      const [hebrewMonth, hebrewDay] = holiday.hebrewDate.split('-').map(Number)
    ...
    const existingEvent = customEvents.value.find(
      (e) => e.date.getTime() === eventDate.getTime() && e.title === holiday.title
    )
  ...
  try {
    ...
    const response = await fetch('/api/calendar/generate-pdf', {
      ...
      body: JSON.stringify({
        ...
        timeZone: config.value.timeZone || Intl.DateTimeFormat().resolvedOptions().timeZone,
    ...
    if (response.ok) {
      ...
      if (template.configuration) {
        ...
        if (template.configuration.customDates) {
          ...
          customEvents.value = Object.entries(template.configuration.customDates).map(
            ([date, data]) => {
  ...
  autoSaveTimeout.value = setTimeout(async () => {
    ...
    try {
      ...
      if (currentCalendarId.value) {
        ...
        const response = await fetch(`/api/session-calendar/${currentCalendarId.value}/autosave`, {
          method: 'PUT',
...
const loadCalendarFromUrl = async () => {
  ...
  if (calendarId) {
      ...
      if (response.ok) {
        ...
        if (calendar.configuration) {
          ...
          if (calendar.configuration.customDates) {
            customEvents.value = Object.entries(calendar.configuration.customDates).map(
              ([date, eventData]) => {
                const isNewFormat = typeof eventData === 'object' && eventData !== null
                return {
                  date: new Date(date),
    ...
    try {
      const response = await fetch(`/api/session-calendar/from-template/${templateId}`, {
        method: 'POST',
      })
      ...
      if (response.ok) {
        ...
        if (data.configuration) {
          ...
          if (data.configuration.customDates) {
            customEvents.value = Object.entries(data.configuration.customDates).map(
              ([date, eventData]) => {
                const isNewFormat = typeof eventData === 'object' && eventData !== null
                return {
                  date: new Date(date),
...
const saveToLocalStorage = () => {
  if (typeof window !== 'undefined' && window.localStorage) {
    try {
      ...
      localStorage.setItem('calendarGeneratorConfig', JSON.stringify(dataToSave))
    } catch (error) {
...
const loadFromLocalStorage = () => {
  if (!userStore.isLoggedIn && typeof window !== 'undefined' && window.localStorage) {
    try {
...
const loadCalendarPreviews = async () => {
  for (const calendar of savedCalendars.value) {
    ...
    try {
      const response = await fetch(`/api/calendar-templates/user/calendars/${calendar.id}/preview`)
      if (response.ok) {
      ...
      console.error(`Error loading preview for calendar ${calendar.id}:`, error)
      calendarPreviews.value[calendar.id] = 'error'
    }
  }
}
...
const loadSavedCalendar = (calendar) => {
  ...
  customEvents.value = []
  if (calendar.configuration.customDates) {
    Object.entries(calendar.configuration.customDates).forEach(([dateStr, data]) => {
      // Handle both old format (emoji string) and new format (object with settings)
      const isNewFormat = typeof data === 'object' && data !== null && data.emoji
      const event = {
...
const deleteSavedCalendar = async (calendar) => {
  ...
  try {
    const response = await fetch(`/api/calendar-templates/user/calendars/${calendar.id}`, {
      method: 'DELETE',
    })
...
const loadTemplateConfig = async (template) => {
  if (template.configuration) {
    ...
    try {
      const response = await fetch(`/api/session-calendar/from-template/${template.id}`, {
        method: 'POST',
      })
      ...
      if (response.ok) {
        ...
        if (result.configuration) {
          ...
          if (result.configuration.customDates) {
            customEvents.value = Object.entries(result.configuration.customDates).map(
              ([date, data]) => {
                // Handle both old format (emoji string) and new format (object with settings)
                const isNewFormat = typeof data === 'object' && data !== null
                return {
...
const confirmSaveTemplate = async () => {
  ...
  try {
    ...
    toast.add({
      severity: 'error',
      summary: 'Save Failed',
      detail: error.message || 'Failed to save template. Please check the console for details.',
      life: 5000,
    })
  }
}
...
const updateTemplate = async (template) => {
  ...
  try {
    const response = await fetch(`/api/calendar-templates/admin/${template.id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
...
const confirmDuplicateTemplate = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      detail:
        error.message || 'Failed to duplicate template. Please check the console for details.',
      life: 5000,
    })
  }
}
