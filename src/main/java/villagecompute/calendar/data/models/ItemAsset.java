...
/**
 * Stores generated SVG content for cart items and orders.
 * Supports multiple assets per item (e.g., main SVG and answer key for mazes).
 */
@Entity
...
public class ItemAsset extends PanacheEntityBase {
     ...
     */
    @Column(name = "width_inches", precision = 5, scale = 2)
    public BigDecimal widthInches;

    /**
     * Height of the asset in inches (e.g., 23 for poster).
     */
    @Column(name = "height_inches", precision = 5, scale = 2)
     ...
     */
    public static ItemAsset create(String assetKey, String svgContent, BigDecimal widthInches, BigDecimal heightInches) {
