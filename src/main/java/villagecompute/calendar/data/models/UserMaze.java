...
public class UserMaze extends DefaultPanacheEntityWithTimestamps {
    ...
    @Column(name = "maze_type", nullable = false, length = 20)
    public MazeType mazeType = MazeType.ORTHOGONAL;

    /**
     * Size level from 1 to 20.
     * Controls the number of cells in the maze.
     * 1 = simple maze (~15 cells wide), 20 = complex maze (~100 cells wide).
     */
    @NotNull
    ...
    /**
     * Difficulty level from 1 to 20.
     * Controls how long and winding the solution path is.
     * 1 = short direct path, 20 = maximum winding path.
     */
    @NotNull
    @Column(nullable = false)
     ...
     * Examples: showSolution, cellSize, wallThickness, colors
     */
     ...
     */
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "solution_path", columnDefinition = "jsonb", nullable = true)
