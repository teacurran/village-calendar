...
public class CustomEventDisplay {
    ...
    public int getEmojiSize(int defaultSize) {
        return displaySettings.containsKey("emojiSize") ? ((Number) displaySettings.get("emojiSize")).intValue()
                : defaultSize;
    }

    public double getEmojiX(double defaultX) {
        return displaySettings.containsKey("emojiX") ? ((Number) displaySettings.get("emojiX")).doubleValue()
                : defaultX;
    }

    public double getEmojiY(double defaultY) {
        return displaySettings.containsKey("emojiY") ? ((Number) displaySettings.get("emojiY")).doubleValue()
                : defaultY;
    }

    public int getTextSize(int defaultSize) {
        return displaySettings.containsKey("textSize") ? ((Number) displaySettings.get("textSize")).intValue()
                : defaultSize;
    }

    public double getTextX(double defaultX) {
        return displaySettings.containsKey("textX") ? ((Number) displaySettings.get("textX")).doubleValue() : defaultX;
    }

    public double getTextY(double defaultY) {
        return displaySettings.containsKey("textY") ? ((Number) displaySettings.get("textY")).doubleValue() : defaultY;
    }
    ...
    public String getTextColor(String defaultColor) {
        return displaySettings.containsKey("textColor") ? (String) displaySettings.get("textColor") : defaultColor;
    }

    public String getTextAlign(String defaultAlign) {
        return displaySettings.containsKey("textAlign") ? (String) displaySettings.get("textAlign") : defaultAlign;
    }
