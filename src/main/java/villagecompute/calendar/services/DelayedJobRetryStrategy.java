...
/**
 * Retry strategy for delayed jobs using exponential backoff. Formula: 5 seconds + N^4 seconds (capped at 7 days)
 */
public class DelayedJobRetryStrategy {
    ...
    /**
     * Calculate the next retry interval based on number of attempts. Uses exponential backoff: 5 seconds + attempts^4
     * seconds.
     *
     * <p>
     * Example schedule: - Attempt 1: 5 + 1 = 6 seconds - Attempt 2: 5 + 16 = 21 seconds - Attempt 3: 5 + 81 = 86
     * seconds (~1.4 minutes) - Attempt 4: 5 + 256 = 261 seconds (~4.3 minutes) - Attempt 5: 5 + 625 = 630 seconds
     * (~10.5 minutes) - Capped at 7 days for runaway jobs
     *
     * @param attempts
