...
/**
 * Service for managing product catalog and pricing.
 * This is the single source of truth for product codes and prices.
 */
@ApplicationScoped
public class ProductService {
    ...
    public static class Product {
        ...
        public Product(String code, String name, String description, BigDecimal price,
                      List<String> features, String icon, String badge, int displayOrder) {
            this.code = code;
            this.name = name;
