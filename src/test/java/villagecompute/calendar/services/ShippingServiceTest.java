...
/**
 * Unit tests for ShippingService. Tests shipping cost calculation for domestic and international addresses.
 */
@QuarkusTest
class ShippingServiceTest {
    ...
    void testDomesticUSAddress_ReturnsStandardRate() throws Exception {
        ...
        JsonNode usAddress = objectMapper.readTree("{\"country\":\"US\",\"state\":\"TN\",\"city\":\"Nashville\","
        ...
        assertEquals(new BigDecimal("5.99"), shippingCost, "Domestic US shipping should be $5.99");
    }
    ...
    void testInternationalAddress_ThrowsException() throws Exception {
        ...
        JsonNode canadianAddress = objectMapper.readTree("{\"country\":\"CA\",\"state\":\"ON\",\"city\":\"Toronto\","
        ...
        assertTrue(exception.getMessage().contains("CA"), "Error message should mention the country code");
    }

    /** Test that UK addresses are rejected (international). */
    @Test
    void testUKAddress_ThrowsException() throws Exception {
        JsonNode ukAddress = objectMapper.readTree("{\"country\":\"GB\",\"state\":\"\",\"city\":\"London\","
    ...
    void testNullShippingAddress_ThrowsException() {
        ...
        assertTrue(exception.getMessage().contains("required"), "Error message should indicate address is required");
    }
    ...
    void testMissingCountryField_ThrowsException() throws Exception {
        ...
        JsonNode addressWithoutCountry = objectMapper.readTree(
                "{\"state\":\"TN\",\"city\":\"Nashville\"," + "\"street\":\"123 Main St\",\"postalCode\":\"37201\"}");
        ...
        assertTrue(exception.getMessage().contains("Country"), "Error message should mention country field");
    }
    ...
    void testNullCountryField_ThrowsException() throws Exception {
        ...
        JsonNode addressWithNullCountry = objectMapper
                .readTree("{\"country\":null,\"state\":\"TN\",\"city\":\"Nashville\","
                        + "\"street\":\"123 Main St\",\"postalCode\":\"37201\"}");
    ...
    void testEmptyCountryString_ThrowsException() throws Exception {
        ...
        JsonNode addressWithEmptyCountry = objectMapper
                .readTree("{\"country\":\"\",\"state\":\"TN\",\"city\":\"Nashville\","
                        + "\"street\":\"123 Main St\",\"postalCode\":\"37201\"}");
    ...
    void testCountryCodeNormalization_LowercaseUS() throws Exception {
        ...
        JsonNode addressLowercase = objectMapper
                .readTree("{\"country\":\"us\",\"state\":\"CA\",\"city\":\"Los Angeles\","
        ...
        assertEquals(new BigDecimal("5.99"), shippingCost, "Lowercase country code should be normalized to uppercase");
    }
    ...
    void testCountryCodeNormalization_MixedCase() throws Exception {
        JsonNode addressMixedCase = objectMapper.readTree("{\"country\":\"Us\",\"state\":\"TX\",\"city\":\"Austin\","
    ...
    void testCountryCodeWithWhitespace_IsTrimmed() throws Exception {
        JsonNode addressWithWhitespace = objectMapper
                .readTree("{\"country\":\" US \",\"state\":\"FL\",\"city\":\"Miami\","
        ...
        assertEquals(new BigDecimal("5.99"), shippingCost, "Whitespace in country code should be trimmed");
    }
    ...
    void testCalculateRate_USAddress_ReturnsStandardRate() throws Exception {
        JsonNode usAddress = objectMapper.readTree("{\"country\":\"US\",\"state\":\"NY\",\"city\":\"New York\","
                + "\"street\":\"123 Broadway\",\"postalCode\":\"10001\"}");

        BigDecimal rate = shippingService.calculateRate(usAddress);

        assertEquals(new BigDecimal("5.99"), rate, "calculateRate() should return standard rate for US addresses");
    }
    ...
    void testCalculateRate_InternationalAddress_ThrowsException() throws Exception {
        JsonNode mexicoAddress = objectMapper
                .readTree("{\"country\":\"MX\",\"state\":\"CDMX\",\"city\":\"Mexico City\","
    ...
    void testDifferentUSStates_SameRate() throws Exception {
        ...
        for (String state : states) {
            JsonNode address = objectMapper
                    .readTree(String.format("{\"country\":\"US\",\"state\":\"%s\",\"city\":\"Test"
                            + " City\",\"street\":\"123 Test" + " St\",\"postalCode\":\"12345\"}", state));
    ...
    void testCompleteAddress_WithAllFields() throws Exception {
        JsonNode completeAddress = objectMapper.readTree("{\"country\":\"US\",\"state\":\"MA\",\"city\":\"Boston\","
                + "\"street\":\"100 Cambridge St\",\"street2\":\"Suite 200\"," + "\"postalCode\":\"02114\"}");
        ...
        assertEquals(new BigDecimal("5.99"), shippingCost, "Complete address with all fields should work correctly");
    }

    /** Test that address without optional street2 field works. */
    @Test
    void testAddressWithoutOptionalFields() throws Exception {
        JsonNode minimalAddress = objectMapper.readTree("{\"country\":\"US\",\"state\":\"WA\",\"city\":\"Seattle\","
        ...
        assertEquals(new BigDecimal("5.99"), shippingCost, "Address without optional fields should work");
    }
}
