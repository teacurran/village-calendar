...
/**
 * Unit tests for ShippingService. Tests shipping cost calculation for domestic and international
 * addresses.
 */
@QuarkusTest
class ShippingServiceTest {
    ...
    void testInternationalAddress_ThrowsException() throws Exception {
        ...
        assertTrue(
                exception.getMessage().contains("International shipping"),
                "Error message should mention international shipping");
        assertTrue(
                exception.getMessage().contains("CA"),
    ...
    void testMissingCountryField_ThrowsException() throws Exception {
        ...
        JsonNode addressWithoutCountry =
                objectMapper.readTree(
        ...
        assertTrue(
                exception.getMessage().contains("Country"),
    ...
    void testNullCountryField_ThrowsException() throws Exception {
        ...
        JsonNode addressWithNullCountry =
                objectMapper.readTree(
    ...
    void testEmptyCountryString_ThrowsException() throws Exception {
        ...
        JsonNode addressWithEmptyCountry =
                objectMapper.readTree(
    ...
    void testCountryCodeWithWhitespace_IsTrimmed() throws Exception {
        JsonNode addressWithWhitespace =
                objectMapper.readTree(
    ...
    void testCalculateRate_NullAddress_ThrowsException() {
        IllegalArgumentException exception =
                assertThrows(
                        IllegalArgumentException.class, () -> shippingService.calculateRate(null));
    ...
    void testDifferentUSStates_SameRate() throws Exception {
        ...
        for (String state : states) {
            JsonNode address =
                    objectMapper.readTree(
                            String.format(
                                    "{\"country\":\"US\",\"state\":\"%s\",\"city\":\"Test"
                                            + " City\",\"street\":\"123 Test"
                                            + " St\",\"postalCode\":\"12345\"}",
                                    state));
