...
/**
 * Tests for OrderEmailJobHandler Qute template rendering.
 * Ensures templates render correctly with various combinations of null/present fields.
 */
@QuarkusTest
class OrderEmailJobHandlerTemplateTest {
    ...
    void testOrderConfirmationTemplateWithNullShippingAddress() {
        ...
        assertNotNull(html);
        assertTrue(html.contains("Thank You for Your Order"), "Should contain order thank you message");
        assertTrue(html.contains("Shipping address will be confirmed separately"), "Should show placeholder for missing address");
