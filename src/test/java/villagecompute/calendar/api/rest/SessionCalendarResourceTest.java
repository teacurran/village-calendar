...
class SessionCalendarResourceTest {
                        ...
                        .call(
                                () -> {
                                    ...
                                    calendar.configuration =
                                            objectMapper.createObjectNode().put("theme", "classic");
                                    calendar.persist();
                                    return calendar.id;
                                });
    ...
    void testSaveSessionCalendar_CreatesNewCalendar() {
        ...
        UserCalendar calendar =
                QuarkusTransaction.requiringNew()
                        .call(
                                () ->
                                        UserCalendar.<UserCalendar>find("sessionId", testSessionId)
                                                .firstResult());
                        ...
                        .call(
                                () -> {
                                    ...
                                    template.configuration =
                                            objectMapper.createObjectNode(); // Required field
                                    template.persist();
                                    return template.id;
                                });
                ...
                QuarkusTransaction.requiringNew()
                        .call(
                                () -> {
                                    ...
                                    template.configuration =
                                            objectMapper.createObjectNode().put("theme", "minimal");
                                    template.persist();
                                    return template.id;
                                });
    ...
    void testAutosaveCalendar_UpdatesConfiguration() {
                ...
                QuarkusTransaction.requiringNew()
                        .call(
                                () -> {
                                    ...
                                    calendar.isPublic = true;
                                    calendar.configuration =
                                            objectMapper.createObjectNode().put("theme", "old");
                                    calendar.persist();
                                    return calendar.id;
                                });
        ...
        // Verify updates
        UserCalendar calendar =
                QuarkusTransaction.requiringNew().call(() -> UserCalendar.findById(calendarId));
        assertEquals("Updated Name", calendar.name);
        assertEquals(2025, calendar.year);
                ...
                .run(
                        () -> {
                            ...
                            CalendarTemplate existing =
                                    CalendarTemplate.<CalendarTemplate>find("slug", "default")
                                            .firstResult();
                            if (existing != null) {
                                existing.delete();
                            }
                        ...
                        .call(
                                () -> {
                                    CalendarTemplate template =
                                            CalendarTemplate.<CalendarTemplate>find(
                                                            "slug", "test-session-template")
                                                    .firstResult();
