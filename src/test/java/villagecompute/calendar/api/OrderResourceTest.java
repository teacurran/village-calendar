...
public class OrderResourceTest {
    ...
    public void testItemNotFound() {
        ...
        UUID randomItemId = UUID.randomUUID();
        given().when().get("/api/orders/TEST123/items/" + randomItemId + "/pdf").then().statusCode(404);
    }
    ...
    void testPdfDownload_WithCalendarYear_UsesYearFromOrderItem() {
        ...
        CalendarOrder order = QuarkusTransaction.requiringNew().call(() -> {
            ...
            newOrder.shippingAddress = objectMapper.createObjectNode().put("street", "123 Test St")
                    .put("city", "Test City").put("state", "TS").put("postalCode", "12345").put("country", "US");
            newOrder.persist();
