...
/**
 * Tests for CalendarsPageResource.
 * Tests the calendar product pages at /calendars/
 */
@QuarkusTest
class CalendarsPageResourceTest {
    ...
    void testProduct_PassesThroughRequestsWithFileExtensions() {
        ...
        // This will likely 404 from static resource handling, but shouldn't hit our product endpoint
        given()
            .when()
            .get("/calendars/something.css")
            .then()
            .statusCode(404);
    }
