# Project Plan: Village Calendar - Iteration 3
...
**Dependencies:** `I3.T1` (StripeService), `I3.T2` (OrderService)
...
**Parallelizable:** No (requires services implemented)
...
**Dependencies:** `I3.T4` (OrderResolver with placeOrder mutation)
